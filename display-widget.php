...
<form action="" method="get" name="subscribeForm" class="subscribeForm" onsubmit="return false;">
	...
	<fieldset class="subscribeDataTable">
		...
		<?php endif; ?>
		<img class="loading-img" style="display:none;vertical-align:middle;background:none;padding: 5px 3px;" src="<?php echo get_bloginfo('wpurl').'/wp-content/plugins/wp-mailup/images/indicator.white.gif'; ?>" border="0" /><span class="show-response"><noscript><?php _e('Please enable javascript to work with this subscription form.'); ?></noscript></span><p class="muSubmit"><input type="submit" name="submit" value="<?php echo wpml_translate($wpmailup['submitButton'], 'sButton'); ?>" /></p>
	</fieldset>
</form>
<script type="text/javascript">
	...
	jQ(document).ready(function(){
		...
		function viewInfoIcon(status, form)
		{
			...
			{
				case 'loading':
					form.find('.loading-img').attr('src', '<?php echo get_bloginfo('wpurl').'/wp-content/plugins/wp-mailup/images/indicator.white.gif'; ?>');
					form.find('.loading-img').css('display', '');
					break;
				case 'info':
					form.find('.loading-img').attr('src', '<?php echo get_bloginfo('wpurl').'/wp-content/plugins/wp-mailup/images/question.gif'; ?>');
					form.find('.loading-img').css('display', '');
					break;
				default:
			}
