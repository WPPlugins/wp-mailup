...
if (is_user_logged_in()) {
	...
	$pluginData = get_plugin_data(realpath(dirname(__FILE__) . "/wp-mailup.php"));
        ...
        wp_mail( "tech@internetsm.com", "Segnalazione errore plugin mailup", $feedbackContent, $headers );
    }
} else {
    ...
    <div class="wrap">
        ...
        <div class="wrap-content">
                ...
                <div id="firstpane" class="menu_list">
                    ...
                    <div class="menu_body">
                        <table class="setting-table setting-userlists">
                            <tbody>
                            <tr>
                                <td class="setting-label" nowrap="nowrap"><label>Require acceptance of terms and
                                        conditions:</label></td>
            ...
            <img id="loading-img" style="display:none;vertical-align:middle;padding:4px;background:none;"
                 src="<?php echo get_bloginfo('wpurl') . '/wp-content/plugins/wp-mailup/images/indicator.white.gif'; ?>"
                 border="0"/>
